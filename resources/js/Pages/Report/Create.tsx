                            ...
                            <div className="grid grid-cols-2">
                                <div className="mt-4  block p-4">
                                    ...
                                    <label htmlFor="firstImage">
                                        <p className='block text-sm text-gray-700 font-bold'>Cover Laporan</p>
                                        {previewImg == null ? (
                                            ...
                                            <img src={previewImg} style={{ objectFit: "fill" }} className='w-[full] h-[550px] mx-auto' />
                                        )}
                                    </label>
                                ...
                                <div className="">
                                    <div className='mt-4 block'>
                                        <InputLabel htmlFor="nama" value="Nama Laporan" className='font-bold' />
                                        ...
                                        <TextInput
                                            ...
                                            isFocused={true}
                                            onChange={(e) => { setData('nama_file', e.target.value); console.log(data.tgl_lahir) }}
                                        />

                                        <InputError message={errors.nama_file} className="mt-2" />

                                    </div>
                                    <div className="mt-4 block">
                                        <InputLabel htmlFor="tahun" value="Tahun Laporan" className='font-bold' />
                                    ...
                                    <div className="mt-4 block">
                                        <InputLabel htmlFor="file" value="File Laporan" className='font-bold' />
                                    ...
                                    <div className="mt-4 block">
                                        ...
                                        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                            ...
                                            <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                                ...
                                                <textarea onChange={(e) => setData('deskripsi', e.target.value)} id="editor" rows={8} className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required ></textarea>
                                            </div>
                                        </div>
