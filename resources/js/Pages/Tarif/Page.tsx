                        ...
                        {dataTarif.map((res: any, idx) => (
                            <div className="bg-main rounded-3xl shadow-xl p-5 h-full  ">
                                <div className="text-center flex flex-col">
                                    <div className="pb-2">
                                        <h1 className="tracking-wide text-3xl font-bold text-white pb-1">
                                            {res.nama}
                                        </h1>
                                    </div>
                                    <div className="pb-5">
                                        <h1 className="text-md md:text-2xl text-second font-bold py-3">
                                            {`Rp${res?.harga.toLocaleString(
                                                "id-ID"
                                            )}`}
                                            {/* Rp5.000 */}
                                        </h1>
                                    ...
                                    <div className="pb-5">
                                        <h1 className="tracking-wide text-md text-white font-medium pb-1">
                                            Deskripsi:
                                        </h1>
                                    ...
                                    <div className="grid grid-cols-2 md:flex md:flex-row justify-center gap-4 text-center">
                                        {res.gambar_first && (
                                            <div className="bg-second p-5 md:p-3 rounded-full justify-center text-center mx-auto">
                                                <img
                                                    src={`/storage/image/tarif/${res.gambar_first}`}
                                        ...
                                        {res.gambar_second && (
                                            <div className="bg-second p-5 md:p-3 rounded-full justify-center text-center mx-auto">
                                                <img
                                                    src={`/storage/image/tarif/${res.gambar_second}`}
                                        ...
                                        {res.gambar_third && (
                                            <div className="bg-second p-5 md:p-3 rounded-full justify-center text-center mx-auto">
                                                <img
                                                    src={`/storage/image/tarif/${res.gambar_third}`}
                                                    className=" object-contain  w-28 h-28"
                                                    alt=""
                                                    srcSet=""
                                                />
                                        ...
                                        {res.gambar_fourth && (
                                            <div className="bg-second p-5 md:p-3 rounded-full justify-center text-center mx-auto">
                                                <img
                                                    src={`/storage/image/tarif/${res.gambar_fourth}`}
                                                    className=" object-contain  w-28 h-28"
                                                    alt=""
                                                    srcSet=""
                                                />
