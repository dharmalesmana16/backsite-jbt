...
export default function Create({
    ...
    const [secondPreviewImg, setSecondPreview] = useState(null);
    const [thirdPreviewImg, setThirdPreview] = useState(null);
    const [fourthPreviewImg, setFourthPreview] = useState(null);
                        ...
                        <form onSubmit={submit}>
                                    ...
                                    <label htmlFor="firstImage">
                                        ...
                                        {previewImg == null ? (
                                            <div className="p-20 border-2 border-gray-200 border-dashed cursor-pointer">
                                                <p className='text-gray-500 text-lg text-center'>+ Img</p>
                                            </div>
                                        ) : (
                                            <img src={previewImg} style={{ objectFit: "fill" }} className='w-36 h-36 cursor-pointer' />
                                        )}
                                    </label>
                                ...
                                <div className="">
                                    ...
                                    <label htmlFor="secondImage">
                                        ...
                                        {secondPreviewImg == null ? (
                                            ...
                                            <img src={secondPreviewImg} style={{ objectFit: "fill" }} className='w-36 h-36 cursor-pointer' />
                                        )}
                                    </label>
                                    {/* <input type="file" name="" id="" /> */}
                                    <input disabled={previewImg == null ? true : false} type="file" name='previewImg1' id='secondImage' style={{ display: "none" }} onChange={secondPreview} />
                                </div>
                                <div className="">
                                    ...
                                    <label htmlFor="thirdImage">
                                        ...
                                        {thirdPreviewImg == null ? (
                                            ...
                                            <img src={thirdPreviewImg} style={{ objectFit: "fill" }} className='w-36 h-36 cursor-pointer' />
                                        )}
                                    </label>
                                    {/* <input type="file" name="" id="" /> */}
                                    <input disabled={secondPreviewImg == null ? true : false} type="file" name='previewImg1' id='thirdImage' style={{ display: "none" }} onChange={thirdPreview} />
                                </div>
                                <div className="">
                                    ...
                                    <label htmlFor="fourthImage">
                                        ...
                                        {fourthPreviewImg == null ? (
                                            ...
                                            <img src={fourthPreviewImg} style={{ objectFit: "fill" }} className='w-36 h-36 cursor-pointer' />
                                        )}
                                    </label>
                                    {/* <input type="file" name="" id="" /> */}
                                    <input disabled={thirdPreviewImg == null ? true : false} name='previewImg1' id='fourthImage' style={{ display: "none" }} onChange={fourthPreview} />
                                </div>
                            ...
                            <div className='mt-4 block'>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="">
                                        <InputLabel htmlFor="nama_golongan" value="Nama Golongan" className='font-bold' />
                                    ...
                                    <div className="">
                                        <InputLabel htmlFor="nama" value="Tarif Golongan" className='font-bold' />
