                            ...
                            <div className="grid grid-cols-2">
                                <div className="mt-4  block p-4">
                                    ...
                                    <label htmlFor="firstImage">
                                        ...
                                        {previewImg != null ? (
                                            ...
                                            <img src={data.file ? `/storage/image/prestasi/${data.file}` : previewImg} style={{ objectFit: "fill" }} className='w-[275px] h-[375px] mx-auto' />
                                        )}
                                    </label>
                                ...
                                <div className="">
                                    <div className='mt-4 block'>
                                        <InputLabel htmlFor="nama" value="Judul Penghargaan" className='font-bold' />
                                        ...
                                        <TextInput
                                            ...
                                            isFocused={true}
                                            onChange={(e) => { setData('nama', e.target.value); console.log(data.tanggal) }}
                                        />
                                    ...
                                    <div className='mt-4 block'>
                                            <div className="">
                                                <InputLabel htmlFor="jabatan" value="Tanggal Terima Penerimaan " className='font-bold' />
                                                <NoteLabel value="Masukkan Tanggal Penerimaan Penghargaan (Opsional)" />

                                                    <Datepicker value={new Date(slug.tanggal)} onChange={handleDateChange} />
