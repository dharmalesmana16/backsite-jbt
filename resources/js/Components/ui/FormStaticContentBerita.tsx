...
export default function FormStaticContentBerita({ dataBerita }: any) {
    const [previewCoverBerita, setPreviewCoverBerita] = useState<any>(null);
    const { data, setData, processing, errors } = useForm({
        cover: dataBerita.cover,
        text_header: dataBerita.text_header,
        text_sub_header: dataBerita.text_sub_header,
        bg_color: dataBerita.bg_color,
        // bg_warna_berita: "",
        // bg_warna_layanan: "",
    });
